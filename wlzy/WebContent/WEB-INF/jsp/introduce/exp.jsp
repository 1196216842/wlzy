...
<link rel="stylesheet" type="text/css"
	href="${pageContext.request.contextPath }/css/exp.css" />
</head>
<body>
	<div id="list">
		...
		<div class="nav">
			...
			</a> <a href="myFileAction_expList.action">物理实验</a>
		</div>
		<div class="content">
			<div id="exp">
				<div id="expTitle">物理实验</div>
			...
			<form id="expForm" action="fileHandleAction_uploadEXP.action" method="post" enctype="multipart/form-data">
					<p>标题: <input class="title" type="text" name="title"></p> 
					<p> <input id="expFile" class="file" type="file" name="file"></p>
					<p class="uploadType" title="word、pdf">支持:&nbsp;word、pdf</p>
					<p> <input class="submit" type="button" value="上传" onclick="uploadEXP()"></p>
			</form>
			</s:if>
			</div>
		</div>

...
<div id="addUI">
		<!-- 表单区域 -->
		<div id="addForm">
			<div id="addForum_content" style="display:none;">${requestScope.reply.content}</div>
			<form id="form1"  action="replyAction_edit.action" method="post">
				<input type="hidden" name="id" value="${requestScope.reply.id}" />
				<input id="title" type="hidden" name="title" value="${requestScope.reply.title}" />
				<p id="reply_title" title="${requestScope.reply.title }">回复:${requestScope.reply.title }</p>
